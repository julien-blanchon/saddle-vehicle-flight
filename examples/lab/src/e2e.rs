...
use saddle_vehicle_flight::FlightSystems;

use crate::scenarios;

pub struct FlightLabE2EPlugin;

impl Plugin for FlightLabE2EPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(E2EPlugin);
        app.configure_sets(Update, E2ESet.before(FlightSystems::ResolveControls));
